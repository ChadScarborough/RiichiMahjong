...
public static class StandardTileList
{
    ...
    public static readonly Tile EAST_WIND = TileFactory.CreateTile(EAST_WIND_C, WIND);
    public static readonly Tile SOUTH_WIND = TileFactory.CreateTile(SOUTH_WIND_C, WIND);
    public static readonly Tile WEST_WIND = TileFactory.CreateTile(WEST_WIND_C, WIND);
    public static readonly Tile NORTH_WIND = TileFactory.CreateTile(NORTH_WIND_C, WIND);
    public static readonly Tile GREEN_DRAGON = TileFactory.CreateTile(GREEN_DRAGON_C, DRAGON);
    public static readonly Tile RED_DRAGON = TileFactory.CreateTile(RED_DRAGON_C, DRAGON);
    public static readonly Tile WHITE_DRAGON = TileFactory.CreateTile(WHITE_DRAGON_C, DRAGON);
