...
namespace RMUTests.ShantenTests
{
    ...
    public class ConsecutiveTaatsuExtractorTest
    {
        ...
        {
            TileCollection man = new TileCollection(MAN, new List<Tile> { FourMan(), FiveMan() });
        ...
        {
            TileCollection pin = new TileCollection(PIN, new List<Tile> { EightPin(), NinePin() });
        ...
        {
            TileCollection sou = new TileCollection(SOU, new List<Tile> { ThreeSou(), FourSou(), FiveSou() });
        ...
        {
            TileCollection man = new TileCollection(MAN, new List<Tile> { OneMan(), TwoMan() });
        ...
        {
            TileCollection pin = new TileCollection(PIN, new List<Tile> { SevenPin(), EightPin() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(pin);
        ...
        {
            TileCollection sou = new TileCollection(SOU, new List<Tile> { TwoSou(), ThreeSou(), FourSou(), FiveSou() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(sou);
        ...
        {
            TileCollection man = new TileCollection(MAN, new List<Tile> { ThreeMan(), FourMan(), SixMan(), EightMan(), NineMan() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(man);
        ...
        {
            TileCollection pin = new TileCollection(PIN, new List<Tile> { SixPin(), SixPin(), SevenPin(), SevenPin() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(pin);
        ...
        {
            TileCollection sou = new TileCollection(SOU, new List<Tile> { TwoSou(), ThreeSou(), ThreeSou(), FourSou(), FourSou(), FiveSou() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(sou);
            Assert.AreEqual(0, sou.GetSize());
        ...
        {
            TileCollection man = new TileCollection(MAN, new List<Tile> { FiveMan(), SixMan(), SixMan() });
            List<ICompleteHandComponent> components = ConsecutiveTaatsuExtractor.ExtractConsecutiveTaatsu(man);
            Assert.AreEqual(1, man.GetSize());
            Assert.AreEqual(1, components.Count);
        }
